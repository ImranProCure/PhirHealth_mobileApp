...
class LegalComplianceView extends GetView<LegalComplianceController> {
  const LegalComplianceView({super.key});
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Upload Drug License
                  GestureDetector(
                    onTap: controller.pickDrugLicense,
                    child: Obx(() {
                      final path = controller.drugLicensePath.value;
                      return Container(
