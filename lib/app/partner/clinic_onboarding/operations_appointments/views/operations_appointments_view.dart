...
class OperationsAppointmentsView
    extends GetView<OperationsAppointmentsController> {
  const OperationsAppointmentsView({super.key});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Days — index based toggle, red = holiday
                        Obx(() => Row(
                  ...
                  _buildServiceToggleCard(
                    ...
                    subtitle: 'Enable real-time digital booking',
                    rxValue: controller.appointmentBooking,
                    onChanged: (v) => controller.appointmentBooking.value = v,
                  ),
