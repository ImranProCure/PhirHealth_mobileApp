  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        bottom: true,
        child: Obx(() {
          // Show shimmer while either list is loading on first load
          if (controller.isFamilyConditionsLoading.value ||
              controller.isSymptomsLoading.value) {
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(() => Wrap(
                      ...
                      runSpacing: 12,
                      children: [
                        ...controller.familyConditions.map((item) => _chip(
                              label: item,
                              selected: controller.selectedFamilyConditions
                                  .contains(item),
                              onTap: () =>
                                  controller.toggleFamilyCondition(item),
                            )),
                        // ---- Add Other chip ----
                        _chip(
                          label: 'Add Other',
