...
class CancerstomachAssessmentController extends GetxController {
  late String area;
  late String gender;
  ...
  final List<Map<String, dynamic>> questions = [
    {
      'question':
          'Do you experience persistent stomach pain or discomfort lasting more than 2 weeks?',
    ...
    {
      'question':
          'Do you often feel bloated or unusually full after eating small amounts?',
      'subtitle': 'Lifestyle and genetics play a major role in risk analysis.',
      'options': ['Yes, Frequently', 'Occasionally', 'No, Never'],
      'imagePath': 'assets/icons/Mask group-2.png',
    },
    {
      'question': 'Have you noticed blood in your stool or black/tarry stools?',
      'subtitle': 'Lifestyle and genetics play a major role in risk analysis.',
      'options': ['Yes, I have', 'No, never', 'Not sure'],
      'imagePath': 'assets/icons/Mask group-2.png',
    },
