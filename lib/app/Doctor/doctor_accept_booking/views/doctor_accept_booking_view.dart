                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          if (controller.isReturningPatient)
                            ShaderMask(
                    ...
                    controller.medicalRecords.isEmpty
                        ? const Text('No reports uploaded',
                            style: TextStyle(
                                ...
                                color: Color(0xFF6B7280)))
                        : Column(
                            children: controller.medicalRecords.map((r) {
                                  ...
                                  children: [
                                    ...
                                    if (files.isNotEmpty) ...[
                                      ...
                                      ...files.map((f) {
                                        final fileUrl =
                                            f['file_url']?.toString() ?? '';
                                        final fullUrl = fileUrl
                                                .startsWith('http')
                                            ? fileUrl
                                            : 'https://scaphoid-donte-uncompellable.ngrok-free.dev$fileUrl';
