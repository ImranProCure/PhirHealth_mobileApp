...
class VerifyMobileSignupView extends GetView<VerifyMobileSignupController> {
  const VerifyMobileSignupView({super.key});
...
class _VerifyButton extends GetView<VerifyMobileSignupController> {
  const _VerifyButton();
